...
services.forEach(function (service) {
    ...
    if (extra && extra.displayName) {
        ...
        slide.addText("Short Description:",      {x: 100, y: 150, cx: '600', font_size: 20, bold: true });
        slide.addText(service.entity.description,{x: 100, y: 180, cx: '1100', font_size: 20});
        
        slide.addText("Long Description:",       {x: 100, y: 300, cx: '100%', font_size: 20, bold: true });
        slide.addText(extra.longDescription,     {x: 100, y: 330, cx: '1100', font_size: 20});
        
        slide.addText("Author: ",                {x: 100, y: 530, cx: '100%', font_size: 20, bold: true });
        slide.addText(extra.providerDisplayName, {x: 100, y: 560, cx: '100%'});
        ...
        slide.addText("Short Description:",      {x: 100, y: 150, cx: '600', font_size: 20, bold: true });
        slide.addText(service.entity.description,{x: 100, y: 180, cx: '100%', font_size: 20});
